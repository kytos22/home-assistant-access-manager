...
Access Manager 0.12.2 recommends ESPHome Fingerprint Access Reader 0.5.2. The panel can generate release-pinned ESPHome YAML for the reference display terminal or a reader-only installation on any ESPHome-supported ESP32 board. Firmware 0.5.2 publishes its installed version during boot; firmware 0.5.1 fixed fresh compilation of the release-pinned display profile.
