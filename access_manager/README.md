...
- Assigns optional door contact sensors and records lock or physical-door opening and closing transitions even when they happen outside Access Manager.
- Uses Home Assistant mobile-app NFC tags as fixed door identifiers, with permissions assigned from each user's credential area.
- Generates release-pinned ESPHome configurations and reports compatible reader firmware versions.
